...
> {
  ...
  private renderExampleCommit() {
    ...
    const dummyCommit = new Commit(
      name,
      name.slice(0, 7),
      t('configureGit.exampleCommitSummary'),
      '',
      author,
      author,
      [],
    ...
    return (
      <div id="commit-list" className="commit-list-example">
        <div className="header">{t('configureGit.exampleCommit')}</div>
  ...
  private renderAuthorOptions() {
    ...
    return (
      <div>
        <RadioButton
          label={t('configureGit.useAccount', {
            accountType: `GitHub${accountTypeSuffix}`,
          })}
        ...
        />
        <RadioButton
          label={t('configureGit.configureManually')}
          checked={!this.state.useGitHubAuthorInfo}
      ...
      <Form className="sign-in-form" onSubmit={this.save}>
        <div className="sign-in-form-inputs">
          <TextBox
            ...
            placeholder={t('configureGit.namePlaceholder')}
