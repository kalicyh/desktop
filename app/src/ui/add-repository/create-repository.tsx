...
> {
  ...
  private renderGitIgnores() {
    ...
    return (
      <Row>
        <Select
          label={t('addRepository.gitIgnore')}
  ...
  private renderInvalidPathError() {
    ...
    return (
      <DialogError>
        {t('addRepository.error.directoryCouldNotBeCreated')}
      </DialogError>
    )
  }
    ...
    return (
      <Row>
        <InputError
          ...
          ariaLiveMessage={t('addRepository.error.existingRepositoryAria', {
            path: fullPath,
          })}
        >
          {t('addRepository.error.existingRepositoryPrefix')}{' '}
          <Ref>{fullPath}</Ref>{' '}
          {t('addRepository.error.existingRepositoryMiddle')}{' '}
          <LinkButton onClick={this.onAddRepositoryClicked}>
            {t('addRepository.error.addThisRepository')}
          </LinkButton>{' '}
          {t('addRepository.error.existingRepositorySuffix')}
        </InputError>
      </Row>
    )
  }
    ...
    return (
      <Row>
        <InputWarning
          ...
          trackedUserInput={fullPath}
          ariaLiveMessage={t('addRepository.warning.subfolderAria', {
            path: fullPath,
          })}
        >
          {t('addRepository.warning.subfolderPrefix')} <Ref>{fullPath}</Ref>{' '}
          {t('addRepository.warning.subfolderSuffix')}{' '}
          <LinkButton uri={submoduleDocsUrl}>
            {t('addRepository.warning.learnAboutSubmodules')}
          </LinkButton>
        </InputWarning>
      </Row>
    )
    ...
    return (
      <Row>
        <InputWarning
          ...
          ariaLiveMessage={t('addRepository.warning.readmeOverwriteAria')}
        >
          {t('addRepository.warning.readmeOverwritePrefix')}{' '}
          <Ref>README.md</Ref>{' '}
          {t('addRepository.warning.readmeOverwriteSuffix')}
        </InputWarning>
      </Row>
    )
  }
  ...
  private renderPathMessage = () => {
    ...
    return (
      <div id="create-repo-path-msg">
        {t('addRepository.createAtPrefix')} <Ref>{fullPath}</Ref>.
      </div>
    )
  }
  ...
  public render() {
    ...
    return (
      <Dialog
        ...
        title={t('addRepository.createTitle')}
      ...
      >
        ...
        <DialogContent>
          <RepositoryPath
            ...
            namePlaceholder={t('addRepository.repositoryNamePlaceholder')}
            pathPlaceholder={t('clone.repositoryPathPlaceholder')}
          ...
          <Row>
            <Checkbox
              label={t('addRepository.initializeWithReadme')}
              value={
        ...
        <DialogFooter>
          ...
          <OkCancelButtonGroup
            okButtonText={t('addRepository.createRepositoryButton')}
